...
def demo_polygon_integration():
    ...
    print("     --window-days 7 --out <repo_root>/data/historical/1m/SPY_POLY_TEST.parquet \\")
    ...
    print("     --window-days 7 --out <repo_root>/data/historical/1m/SPY_POLY_6W_TEST.parquet \\")
