...
class AblationRunner:
    ...
    def __init__(
        ...
        self.output_dir = Path(output_dir or "data/backtest_results/ablation")
...
def main():
    ...
    parser.add_argument("--data-dir", default="data/historical/1m", help="Répertoire des Parquet 1m")
    parser.add_argument("--output-dir", default="data/backtest_results/ablation", help="Répertoire de sortie")
