...
**Résultat attendu :** `SPY data: True at C:\bots\dexterio\data\historical\1m\SPY.parquet`
...
**Résultat attendu :**
```
Job dir: C:\bots\dexterio\backend\results\jobs\a1b2c3d4
Exists: True
  job.json
  job.log
  summary.json
