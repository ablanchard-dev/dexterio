...
if ($currentDir.Path -ne "C:\bots\dexterio") {
    Write-Host "  ⚠️  Vous n'êtes pas dans C:\bots\dexterio" -ForegroundColor Red
    Write-Host "  Exécutez: cd C:\bots\dexterio" -ForegroundColor Yellow
    exit 1
}
...
Write-Host "   cd C:\bots\dexterio" -ForegroundColor White
...
Write-Host "   cd C:\bots\dexterio\frontend" -ForegroundColor White
